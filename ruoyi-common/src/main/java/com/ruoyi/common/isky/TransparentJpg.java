...
public class TransparentJpg {
        ...
        for (int i = 0; i < height; i++) {
            for (int j = 0; j < width; j++) {
                ...
                if (isRGB198(dip)) {
                    ...
                    if ((count == 0 && i == 0)
                            || (j == 0 && !isRGB198(updip) && isRGB198(downdip) && isRGB198(rightdip))) {
                        Block b = new Block();
                        b.xstart = j;
                        b.ystart = i;
                        count++;
                        block.add(b);
                            ...
                            || (j == width - 1 && isRGB198(updip) && !isRGB198(downdip) && isRGB198(leftdip))) {
                        if (count > 0) {
                    ...
                    if ( !isRGB198(updip) && isRGB198(downdip) && !isRGB198(leftdip) && isRGB198(rightdip)) {
                        if (count >0) {
                            int k = 0;
                    ...
                    } else if (isRGB198(updip) && !isRGB198(downdip) && isRGB198(leftdip)
                            && !isRGB198(rightdip)) {
                        int k = 0;
    ...
    public static boolean isRGB198(int rgb1) {
        int r1 = (rgb1 >> 16) & 0xFF;
        int g1 = (rgb1 >> 8) & 0xFF;
        int b1 = (rgb1 >> 0) & 0xFF;
        boolean flag = false;
        if (r1 == 198 && g1 == 198 && b1 == 198) {
            flag = true;
        }
        return flag;
    }

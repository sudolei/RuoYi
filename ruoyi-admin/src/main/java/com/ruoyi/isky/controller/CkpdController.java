...
@Controller
@RequestMapping({"/pd"})
public class CkpdController extends BaseController {

    private String prefix = "isky/pd";
    ...
    public AjaxResult editCk(String mydatas) {
        try {
            ...
            String warehouseE = "0";
            if (jsonObject.has("warehouseE")) {
                warehouseE = jsonObject.getString("warehouseE");
            }
            ...
            goods.setWarehouseE(Integer.parseInt(warehouseE));

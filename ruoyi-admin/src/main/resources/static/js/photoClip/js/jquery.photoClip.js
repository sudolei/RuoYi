/**
 * jQuery photoClip v1.8.0 依赖插件 - iscroll-zoom.js - hammer.js -
 * lrz.all.bundle.js
 *
 ...
 *               //@option_param {string} outputType 指定输出图片的类型，可选 "jpg" 和 "png"
 *               两种种类型，默认为 "jpg"
 ...
 *               裁剪完成的回调函数。this指向原图片对象，会将裁剪出的图像数据DataURL作为参数传入
 */
...
(function (root, factory) {
    ...
    function photoClip(container, option) {
        ...
        /*
         * if (outputType === "jpg") { outputType = "image/jpeg"; } else if
         * (outputType === "png") { outputType = "image/png"; }
         */
        var $file = $(file);
        ...
        function clipImg() {
            ...
            clipFinish.call($img[0], dataURL, local.x, local.y, staticAngle, scale,curX,curY);
        }
        ...
        // var img_
        // ="http://hype.oss-cn-beijing.aliyuncs.com/huangjialipao_cup.hyperesources/1-1.jpg";
        var img_ = $("#img_").val();
        createImg(img_)
